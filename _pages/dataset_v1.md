...
<button class="expansion-panel" onclick="togglePanel('panel1')">Click to Expand/Collapse Panel 1</button>

<!-- Panel Content -->
<div id="panel1" class="expansion-content" style="display: none;">
    <p>This is the content of Panel 1. It will be shown or hidden when the panel is clicked.</p>
</div>

<!-- Expansion Panel Button -->
<button class="expansion-panel" onclick="togglePanel('panel2')">Click to Expand/Collapse Panel 2</button>

<!-- Panel Content -->
<div id="panel2" class="expansion-content" style="display: none;">
    <p>This is the content of Panel 2. It will be shown or hidden when the panel is clicked.</p>
</div>
